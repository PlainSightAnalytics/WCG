CREATE TABLE [dbo].[DimTime] (
    ...
    [HalfHourBand]    VARCHAR (10)  DEFAULT ('Unknown') NOT NULL,
    [Hour12]          INT           DEFAULT ((0)) NOT NULL,
    ...
    [MinuteOfHour]    INT           DEFAULT ((0)) NOT NULL,
    [PeriodOfDay]     VARCHAR (10)  DEFAULT ('Unknown') NOT NULL,
    [QuarterHourBand] VARCHAR (10)  DEFAULT ('Unknown') NOT NULL,
    [Shift]           VARCHAR (10)  DEFAULT ('Unknown') NOT NULL,
    [TimeName]        VARCHAR (10)  DEFAULT ('Unknown') NOT NULL,
    ...
    CONSTRAINT [PK_dbo.DimTime] PRIMARY KEY CLUSTERED ([TimeKey] ASC),
    CONSTRAINT [FK_dbo_DimTime_InsertAuditKey] FOREIGN KEY ([InsertAuditKey]) REFERENCES [dbo].[DimAudit] ([AuditKey]),
    CONSTRAINT [FK_dbo_DimTime_UpdateAuditKey] FOREIGN KEY ([UpdateAuditKey]) REFERENCES [dbo].[DimAudit] ([AuditKey])
);
