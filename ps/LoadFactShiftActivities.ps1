<# 
Script:  LoadFactShiftActivities
Purpose: Loads new and updated rows to DimShiftActivityType and FactShiftActivities
Author:  Trevor Howe
Date:    22-10-2018
#>
...
Try 
{
    ...
    if ($UnloadedDeltas.Count -gt 0) 
    {
        ...
        foreach ($DeltaLogKey in $UnloadedDeltas) {
            ...
            # Load DimShift first
            $SqlCmd.CommandText = "dbo.prcLoadDimShiftActivityType"
            $SqlCmd.Parameters.Clear()
