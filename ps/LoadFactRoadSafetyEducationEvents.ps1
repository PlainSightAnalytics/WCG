<# 
Script:  LoadFactRoadSafetyEducationEvents
Purpose: Loads new and updated rows to FactRoadSafetyEducationEvents
Author:  Trevor Howe
Date:    06-04-2019
...
Try 
{
    ...
    # Declare Variables
    $tablename = "FactRoadSafetyEducationEvents"
    $clientname = "WCG"
    $schemaname = "itis"
    $objectname = "event_road_safety_topic"
    $auditkey = -1
    $ExecutionLogKey = -1
    $UnloadedDeltas = @()
