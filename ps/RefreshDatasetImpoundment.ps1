<# 
----------------------------------------------------------------------------------------------------------------
Script:  RefreshModelDatasetImpound.ps1
Purpose: Refreshes Power BI data set for Impoundment dashboard on various accounts
Author:  Trevor Howe
Date:    10-08-2019
----------------------------------------------------------------------------------------------------------------
Change Date:
...
Try 
{
    ...
    $pbiDatasetId = "e6cd31bd-b01f-40b1-b667-c8353dc357fc"
    ...
    $pbiDatasetId = "69b26a3e-b246-4099-8a21-91ab721c6655"
    $authUrl = "https://login.windows.net/common/oauth2/token/"
