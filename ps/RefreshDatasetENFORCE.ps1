<# 
----------------------------------------------------------------------------------------------------------------
Script:  RefreshModelDataENFORCE.ps1
Purpose: Refreshes Power BI data set for ENFORCE dashboard on various accounts
Author:  Trevor Howe
Date:    10-08-2019
----------------------------------------------------------------------------------------------------------------
Change Date:
...
Try 
{
    ...
    $pbiDatasetId = "f2d9a8fc-d7da-48c7-b168-68bced3fa8c1"
    ...
    $pbiDatasetId = "753c5b2f-70b9-4cd0-b5ba-2a9f432a2852"
    $authUrl = "https://login.windows.net/common/oauth2/token/"
