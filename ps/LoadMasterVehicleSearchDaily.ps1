<# 
------------------------------------------------------------------
Script:  LoadMasterVehicleSearchDaily
Purpose: Executes Power Shell scripts to prepare and upload daily Vehicle Search data
Author:  Trevor Howe
Date:    07-12-2019
------------------------------------------------------------------
Change Date: 
...
Try 
{
    ...
    Invoke-Expression ($ScriptFolder + "LoadVehicleSearch.ps1")

    # Upload to App Server
    Invoke-Expression ($ScriptFolder + "UploadVehicleSearch.ps1")

    # Reset Stage Vehicle Search
    Invoke-Expression ($ScriptFolder + "ResetVehicleSearchStage.ps1")
