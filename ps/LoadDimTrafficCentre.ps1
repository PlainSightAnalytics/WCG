<# 
Script:  LoadDimTrafficCentre
Purpose: Loads new and updated rows to DimTrafficCentre
Author:  Trevor Howe
Date:    18 June 2016
#>
...
Try 
{
    ...
    # Declare Variables
    $tablename = "DimTrafficCentre"
    $clientname = "WCG"
    $schemaname = "itis"
    $objectname = "traffic_centre"
    $auditkey = -1
    $ExecutionLogKey = 0
    $result = 0
    $loadflag = 1
    ...
    $objects = @("traffic_centre","magistrates_court","municipality","district","regional_area","authority","province")
