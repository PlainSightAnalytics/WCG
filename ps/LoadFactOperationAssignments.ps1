<# 
Script:  LoadFactOperationAssignments
Purpose: Loads new and updated rows to FactOperationAssignments
Author:  Trevor Howe
Date:    22-10-2018
#>
...
Try 
{
    ...
    # Declare Variables
    $tablename = "FactOperationAssignments"
    $clientname = "WCG"
    $schemaname = "itis"
    $objectname = "officials_involved_in_operation"
    $auditkey = -1
    $ExecutionLogKey = -1
    $UnloadedDeltas = @()
