<# 
Script:  LoadFactImPoundReleaseCosts
Purpose: Loads new and updated rows to FactImPoundReleaseCosts
Author:  Trevor Howe
Date:    06-02-2019
...
Try 
{
    ...
    # Declare Variables
    $tablename = "FactImPoundReleaseCosts"
    $clientname = "WCG"
    $schemaname = "pnd"
    $objectname = "release_criteria"
    $auditkey = -1
    $ExecutionLogKey = -1
    $UnloadedDeltas = @()
