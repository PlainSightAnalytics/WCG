<# 
Script:  LoadDimJourneyUserPND
Purpose: Loads new and updated rows to DimJourneyUser from Impound
Author:  Trevor Howe
Date:    04-02-2019
#>
...
Try 
{
    ...
    if ($loadflag -eq 0) 
    {
        ...
        # Load Dim
        $SqlCmd.CommandText = "dbo.prcLoadDimJourneyUserCommon"
        $SqlCmd.Parameters.Clear()
