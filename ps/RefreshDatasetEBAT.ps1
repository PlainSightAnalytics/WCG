<# 
----------------------------------------------------------------------------------------------------------------
Script:  RefreshModelDataEBAT.ps1
Purpose: Refreshes Power BI data set for EBAT on various accounts
Author:  Trevor Howe
Date:    10-08-2019
----------------------------------------------------------------------------------------------------------------
Change Date:
...
Try 
{
    ...
    $pbiDatasetId = "8638882d-94eb-4f2f-8580-45ee1cf7331e"
    ...
    $pbiDatasetId = "55a6023b-e714-42dd-b01d-370aee50e020"
    $authUrl = "https://login.windows.net/common/oauth2/token/"
