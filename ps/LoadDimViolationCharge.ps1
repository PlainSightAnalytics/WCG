<# 
Script:  LoadDimViolationCharge
Purpose: Loads new and updated rows to DimViolationCharge
Author:  Trevor Howe
Date:    06-05-2018
#>
...
Try 
{
    ...
    # Declare Variables
    $tablename = "DimViolationCharge"
    $clientname = "WCG"
    $schemaname = "itis"
    $objectname = "charge_code"
    $auditkey = -1
    $ExecutionLogKey = 0
    $result = 0
    $loadflag = 1
    ...
    $objects = @("charge_code","charge_code_category","charge_code_subcategory")
