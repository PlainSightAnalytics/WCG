<# 
----------------------------------------------------------------------------------------------------------------
Script:  RefreshModelDatasetPublicTransport.ps1
Purpose: Refreshes Power BI data set for Public Transport dashboard on various accounts
Author:  Trevor Howe
Date:    10-08-2019
----------------------------------------------------------------------------------------------------------------
Change Date:
...
Try 
{
    ...
    $pbiDatasetId = "af3361df-da73-4985-b3ab-991ce7196552"
    ...
    $pbiDatasetId = "ef41048f-cb4f-4a8d-8f25-a1f9e112739b"
    $authUrl = "https://login.windows.net/common/oauth2/token/"
