<# 
Script:  LoadDimSection56Form
Purpose: Loads new and updated rows to DimSection56Form
Author:  Trevor Howe
Date:    06-05-2018
#>
...
Try 
{
    ...
    # Declare Variables
    $tablename = "DimSection56Form"
    $clientname = "WCG"
    $schemaname = "itis"
    $objectname = "Section56Form"
    $auditkey = -1
    $ExecutionLogKey = 0
    $result = 0
    $loadflag = 1
