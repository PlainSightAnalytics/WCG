...
Try 
{
    ...
    $lkn_object = "last_known_location"
    ...
    # Build Count uri
    $lkn_counturi = "$lkn_BaseURI/$lkn_username/objects/$lkn_object/count.$lkn_objecttype`?q[_updated_at.gt]=$lkn_HighWaterDateTimeString"
    ...
    $lkn_waitseconds =5
    $lkn_limit = 1000
    $lkn_datauri = "$lkn_BaseURI/$lkn_username/objects/$lkn_object.$lkn_objecttype`?sort[`$natural]=1&q[_updated_at.gt]=$lkn_HighWaterDateTimeString"
