<# 
Script:  LoadDimFlaggedVehicleTrip
Purpose: Loads new and updated rows to DimFlaggedVehicleTrip from Latest Sightings data
Author:  Trevor Howe
Date:    10-03-2019
#>
...
Try 
{
    ...
    # Declare Variables
    $pa_tablename = "DimFlaggedVehicleTrip"
    $pa_clientname = "WCG"
    $pa_schemaname = "cle"
    $pa_objectname = ""
    $pa_auditkey = -1
    ...
    # Load Dim
    $pa_SqlCmd.CommandText = "dbo.prcLoadDimFlaggedVehicleTrip"
    $pa_SqlCmd.Parameters.Clear()
