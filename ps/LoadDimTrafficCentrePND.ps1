<# 
Script:  LoadDimTrafficCentrePND
Purpose: Loads new and updated rows to DimTrafficCentre from Impound
Author:  Trevor Howe
Date:    04-02-2019
#>
...
Try 
{
    ...
    if ($loadflag -eq 0) 
    {
        ...
        # Load Dim
        $SqlCmd.CommandText = "dbo.prcLoadDimTrafficCentreCommon"
        $SqlCmd.Parameters.Clear()
