CREATE TABLE [itis].[transformLastKnownLocation] (
...
GO
CREATE NONCLUSTERED INDEX [idxEventDate]
    ON [itis].[transformLastKnownLocation]([user_id] ASC)
    INCLUDE([user_event_date]);
