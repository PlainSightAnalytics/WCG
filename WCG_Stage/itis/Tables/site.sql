CREATE TABLE [itis].[site] (
    ...
    [end_gps_location_latitude]            VARCHAR (MAX)    NULL,
    [end_gps_location_longitude]           VARCHAR (MAX)    NULL,
    [end_gps_location_altitude]            VARCHAR (MAX)    NULL,
    [end_gps_location_horizontal_accuracy] VARCHAR (MAX)    NULL,
    [end_gps_location_vertical_accuracy]   VARCHAR (MAX)    NULL,
    [end_gps_location_timestamp]           VARCHAR (MAX)    NULL,
