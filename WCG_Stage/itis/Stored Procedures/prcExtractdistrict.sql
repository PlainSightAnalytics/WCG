...
CREATE PROCEDURE [itis].[prcExtractdistrict]

--------------------------------------------------------------------------------------------------------------------------------------
-- Author				:	Generated from Model
-- Date Created			:	22-08-2016 04:52:09
-- Reason				:	Reads JSON file and inserts data into Stage table (district)
--------------------------------------------------------------------------------------------------------------------------------------
-- Inputs				:	@FileName, @DeltaLogKey, @AuditKey
-- Ouputs				:	@RowCountStage
-- Test					:	exec itis.prcExtractdistrict 'F:\PSA\WCG\itis\data\samples\district.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [itis].[district]
...
SET @sql = @sql + '[province_id] [varchar](max) ''$.province_id'',' + CHAR(13)
