...
CREATE PROCEDURE [itis].[prcExtractmagistrates_court]

--------------------------------------------------------------------------------------------------------------------------------------
-- Author				:	Generated from Model
-- Date Created			:	21-08-2016 04:38:19
-- Reason				:	Reads JSON file and inserts data into Stage table (magistrates_court)
--------------------------------------------------------------------------------------------------------------------------------------
-- Inputs				:	@FileName, @DeltaLogKey, @AuditKey
-- Ouputs				:	@RowCountStage
-- Test					:	exec itis.prcExtractmagistrates_court 'F:\PSA\WCG\itis\data\samplesmagistrates_court.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [itis].[magistrates_court]
...
SET @sql = @sql + 'INSERT INTO [itis].[magistrates_court] (' + CHAR(13)
