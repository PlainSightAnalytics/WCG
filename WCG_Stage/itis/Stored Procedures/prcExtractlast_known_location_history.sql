...
CREATE PROCEDURE [itis].[prcExtractlast_known_location_history]

--------------------------------------------------------------------------------------------------------------------------------------
-- Author				:	Generated from Model
-- Date Created			:	22-03-2019 01:46:57
-- Reason				:	Reads JSON file and inserts data into Stage table (last_known_location_history)
--------------------------------------------------------------------------------------------------------------------------------------
-- Inputs				:	@FileName, @DeltaLogKey, @AuditKey
-- Ouputs				:	@RowCountStage
-- Test					:	exec itis.prcExtractlast_known_location_history 'D:\PSA\WCG\changes\WCG-0075 - Last Known Location\sample\last_known_location_history.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [itis].[last_known_location_history]
...
SET @sql = @sql + 'INSERT INTO [itis].[last_known_location_history] (' + CHAR(13)
