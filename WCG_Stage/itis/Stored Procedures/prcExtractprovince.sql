...
CREATE PROCEDURE [itis].[prcExtractprovince]

--------------------------------------------------------------------------------------------------------------------------------------
-- Author				:	Generated from Model
-- Date Created			:	21-08-2016 04:38:20
-- Reason				:	Reads JSON file and inserts data into Stage table (province)
--------------------------------------------------------------------------------------------------------------------------------------
-- Inputs				:	@FileName, @DeltaLogKey, @AuditKey
-- Ouputs				:	@RowCountStage
-- Test					:	exec itis.prcExtractprovince 'F:\PSA\WCG\itis\data\samplesprovince.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [itis].[province]
...
SET @sql = @sql + 'INSERT INTO [itis].[province] (' + CHAR(13)
