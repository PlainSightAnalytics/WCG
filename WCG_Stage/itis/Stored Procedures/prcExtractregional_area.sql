...
CREATE PROCEDURE [itis].[prcExtractregional_area]
...
-- Test					:	exec itis.prcExtractregional_area 'F:\PSA\WCG\itis\data\samplesregional_area.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [itis].[regional_area]
...
SET @sql = @sql + 'INSERT INTO [itis].[regional_area] (' + CHAR(13)
