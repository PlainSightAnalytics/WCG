...
CREATE PROCEDURE [itis].[prcExtractoperational_area]

--------------------------------------------------------------------------------------------------------------------------------------
-- Author				:	Generated from Model
-- Date Created			:	21-08-2016 04:38:19
-- Reason				:	Reads JSON file and inserts data into Stage table (operational_area)
--------------------------------------------------------------------------------------------------------------------------------------
-- Inputs				:	@FileName, @DeltaLogKey, @AuditKey
-- Ouputs				:	@RowCountStage
-- Test					:	exec itis.prcExtractoperational_area 'F:\PSA\WCG\itis\data\samplesoperational_area.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @DeltaLogKey = -1 TRUNCATE TABLE [itis].[operational_area]
...
SET @sql = @sql + 'INSERT INTO [itis].[operational_area] (' + CHAR(13)
