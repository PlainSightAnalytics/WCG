...
CREATE PROCEDURE [itis].[prcExtractdeparture_point]

--------------------------------------------------------------------------------------------------------------------------------------
-- Author				:	Generated from Model
-- Date Created			:	02-02-2019 01:55:11
-- Reason				:	Reads JSON file and inserts data into Stage table (departure_point)
--------------------------------------------------------------------------------------------------------------------------------------
-- Inputs				:	@FileName, @DeltaLogKey, @AuditKey
-- Ouputs				:	@RowCountStage
-- Test					:	exec itis.prcExtractdeparture_point 'D:\PSA\WCG\changes\WCG-0067 - Impound\itis\departure_point.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [itis].[departure_point]
...
SET @sql = @sql + 'INSERT INTO [itis].[departure_point] (' + CHAR(13)
