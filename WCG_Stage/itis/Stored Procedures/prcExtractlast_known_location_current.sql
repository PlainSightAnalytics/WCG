...
CREATE PROCEDURE [itis].[prcExtractlast_known_location_current]

--------------------------------------------------------------------------------------------------------------------------------------
-- Author				:	Generated from Model
-- Date Created			:	22-03-2019 01:46:57
-- Reason				:	Reads JSON file and inserts data into Stage table (last_known_location_current)
--------------------------------------------------------------------------------------------------------------------------------------
-- Inputs				:	@FileName, @DeltaLogKey, @AuditKey
-- Ouputs				:	@RowCountStage
-- Test					:	exec itis.prcExtractlast_known_location 'D:\PSA\WCG\changes\WCG-0075 - Last Known Location\sample\last_known_location_current.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
SET @sql = @sql + 'INSERT INTO [itis].[last_known_location_current] (' + CHAR(13)
