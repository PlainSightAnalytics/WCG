...
CREATE PROCEDURE [itis].[prcExtractofficials_involved_in_operation]

--------------------------------------------------------------------------------------------------------------------------------------
-- Author				:	Generated from Model
-- Date Created			:	05-01-2019 09:47:59
-- Reason				:	Reads JSON file and inserts data into Stage table (officials_involved_in_operation)
--------------------------------------------------------------------------------------------------------------------------------------
-- Inputs				:	@FileName, @DeltaLogKey, @AuditKey
-- Ouputs				:	@RowCountStage
-- Test					:	exec itis.prcExtractofficials_involved_in_operation 'D:\PSA\WCG\sql\officials_involved_in_operation.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [itis].[officials_involved_in_operation]
...
SET @sql = @sql + 'INSERT INTO [itis].[officials_involved_in_operation] (' + CHAR(13)
