CREATE PROCEDURE [dbo].[prcUpdateFactTrafficControlEventsOperation]

--------------------------------------------------------------------------------------------------------------------------
-- Author				:	Trevor Howe
-- Date Created			:	09-01-2019
-- Reason				:	Updates FactTrafficControlEvents with Operation based on time and officials involved
--							in the TCE
--------------------------------------------------------------------------------------------------------------------------
-- Inputs				:	@AuditKey
-- Ouputs				:	None
-- Test					:	[dbo].[prcUpdateFactTrafficControlEventsOperation] -1
--------------------------------------------------------------------------------------------------------------------------
-- Modified By			:   
-- Modified On			:   
-- Reason				:   
...
LEFT JOIN WCG_DW.dbo.DimDate d2 ON f.OpenDateKey = d2.DateKey
LEFT JOIN WCG_DW.dbo.DimTime d3 ON f.OpenTimeKey = d3.TimeKey
