...
CREATE PROCEDURE [dbo].[prcLoadDimVehicleAlerts]
...
SELECT
	...
	,VehicleUsage
	,VehicleUsageCode
FROM WCG_STAGE.cle.transformDimVehicleAlerts 
...
SELECT @RowCountExtract = COUNT(1) FROM WCG_STAGE.cle.transformDimVehicleAlerts WHERE DeltaLogKey = @DeltaLogKey
