CREATE PROCEDURE [dbo].[prcLoadDimVehicleEBATReport]
...
SELECT
	...
	,RegistrationNo
	,VehicleUsage
FROM WCG_STAGE.ebat.transformDimVehicle 
)
...
SELECT @RowCountExtract = COUNT(1) FROM WCG_STAGE.ebat.transformDimVehicle WHERE DeltaLogKey = @DeltaLogKey
