...
CREATE PROCEDURE [dbo].[prcLoadDimEBATRolePlayerOfficer]

--------------------------------------------------------------------------------------------------------------------------
-- Author				:	Trevor Howe
-- Date Created			:	23-10-2017
-- Reason				:	Performs SCD Logic for DimEBATRolePlayer from Officer using MERGE statement
--------------------------------------------------------------------------------------------------------------------------
-- Inputs				:	@AuditKey
-- Ouputs				:	None
-- Test					:	[dbo].[prcLoadDimEBATRolePlayerOfficer] -1
--------------------------------------------------------------------------------------------------------------------------
-- Modified By			:   
-- Modified On			:   
-- Reason				:   
...
SELECT
	...
	,RankOrRole
	,Surname
FROM WCG_STAGE.ebat.transformDimEBATRolePlayerOfficer
