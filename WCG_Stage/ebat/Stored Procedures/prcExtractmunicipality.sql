...
CREATE PROCEDURE [ebat].[prcExtractmunicipality]
...
-- Test					:	exec ebat.prcExtractmunicipality 'F:\PSA\WCG\v3\data\municipality.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [ebat].[municipality]
...
SET @sql = @sql + 'INSERT INTO [ebat].[municipality] (' + CHAR(13)
