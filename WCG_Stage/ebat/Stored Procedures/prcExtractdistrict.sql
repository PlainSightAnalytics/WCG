...
CREATE PROCEDURE [ebat].[prcExtractdistrict]

--------------------------------------------------------------------------------------------------------------------------------------
-- Author				:	Generated from Model
-- Date Created			:	12-08-2016 04:57:41
...
-- Test					:	exec ebat.prcExtractdistrict 'F:\PSA\WCG\v3\data\district.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [ebat].[district]
...
SET @sql = @sql + 'INSERT INTO [ebat].[district] (' + CHAR(13)
