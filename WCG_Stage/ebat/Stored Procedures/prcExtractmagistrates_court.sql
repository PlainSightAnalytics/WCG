...
CREATE PROCEDURE [ebat].[prcExtractmagistrates_court]
...
-- Test					:	exec ebat.prcExtractmagistrates_court 'F:\PSA\WCG\v3\data\magistrates_court.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [ebat].[magistrates_court]
...
SET @sql = @sql + 'INSERT INTO [ebat].[magistrates_court] (' + CHAR(13)
