...
CREATE PROCEDURE [ebat].[prcExtractregional_area]

--------------------------------------------------------------------------------------------------------------------------------------
-- Author				:	Generated from Model
-- Date Created			:	12-08-2016 04:57:42
-- Reason				:	Reads JSON file and inserts data into Stage table (regional_area)
--------------------------------------------------------------------------------------------------------------------------------------
-- Inputs				:	@FileName, @DeltaLogKey, @AuditKey
-- Ouputs				:	@RowCountStage
-- Test					:	exec ebat.prcExtractregional_area 'F:\PSA\WCG\v3\data\regional_area.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [ebat].[regional_area]
...
SET @sql = @sql + 'INSERT INTO [ebat].[regional_area] (' + CHAR(13)
