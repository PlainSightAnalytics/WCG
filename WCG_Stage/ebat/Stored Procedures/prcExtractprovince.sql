...
CREATE PROCEDURE [ebat].[prcExtractprovince]
...
-- Test					:	exec ebat.prcExtractprovince 'F:\PSA\WCG\v3\data\province.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [ebat].[province]
...
SET @sql = @sql + 'INSERT INTO [ebat].[province] (' + CHAR(13)
