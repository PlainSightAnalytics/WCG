...
CREATE PROCEDURE [ebat].[prcExtractauthority]
...
-- Test					:	exec ebat.prcExtractauthority 'F:\PSA\WCG\v3\data\authority.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [ebat].[authority]
...
SET @sql = @sql + 'INSERT INTO [ebat].[authority] (' + CHAR(13)
