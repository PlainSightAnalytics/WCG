...
CREATE PROCEDURE [pnd].[prcExtractlocal_municipality]

--------------------------------------------------------------------------------------------------------------------------------------
-- Author				:	Generated from Model
-- Date Created			:	03-02-2019 11:53:08
-- Reason				:	Reads JSON file and inserts data into Stage table (local_municipality)
--------------------------------------------------------------------------------------------------------------------------------------
-- Inputs				:	@FileName, @DeltaLogKey, @AuditKey
-- Ouputs				:	@RowCountStage
-- Test					:	exec pnd.prcExtractlocal_municipality 'D:\PSA\WCG\changes\WCG-0067 - Impound\impound\local_municipality.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [pnd].[local_municipality]
...
SET @sql = @sql + 'INSERT INTO [pnd].[local_municipality] (' + CHAR(13)
