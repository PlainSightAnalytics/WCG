...
CREATE PROCEDURE [its].[prcExtractoperation]
...
-- Test					:	exec its.prcExtractoperation 'D:\PSA\WCG\changes\WCG-0099 - Replace Actuals\operation.json'
--------------------------------------------------------------------------------------------------------------------------------------
-- Modified By	:
-- Modified On	:
-- Reason				:
...
IF @TruncateFlag = 1 TRUNCATE TABLE [its].[operation]
...
SET @sql = @sql + 'INSERT INTO [its].[operation] (' + CHAR(13)
...
SET @sql = @sql + '[roadblock_type], ' + CHAR(13)
