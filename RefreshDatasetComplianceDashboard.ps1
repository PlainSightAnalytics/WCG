<# 
----------------------------------------------------------------------------------------------------------------
Script:  RefreshModelDatasetComplianceDashboard.ps1
Purpose: Refreshes Power BI data set for Compliance Dashboard on various accounts
Author:  Trevor Howe
Date:    12-08-2019
----------------------------------------------------------------------------------------------------------------
Change Date:
...
Try 
{
    ...
    $pbiDatasetId = "e6c5fe03-8bad-4392-a5bc-ddf777356712" 
    ...
    $pbiDatasetId = "97e0a6ee-3ab7-4acd-8b65-57f8cf734dae"
    $authUrl = "https://login.windows.net/common/oauth2/token/"
